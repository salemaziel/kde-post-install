...
sudo apt purge exim4 avahi-autoipd avahi-daemon cups cups-browsed unattended-upgrades cryptsetup-initramfs kate kate5-data -y
...
sudo gdebi -n teamviewer_13.1.8286_amd64.deb
